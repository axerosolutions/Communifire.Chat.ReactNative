export default {
	...
	Invisible: 'Невидимый',
	Invite: 'Приглашение',
	is_a_valid_RocketChat_instance: 'является действительным сервером Communifire',
	is_not_a_valid_RocketChat_instance: 'не является действительным сервером Communifire',
	is_typing: 'печатает',
	...
	Microphone_Permission_Message: 'Communifire нужен доступ к вашему микрофону, чтобы вы могли отправлять аудио сообщения.',
	...
	Not_RC_Server: 'Это не сервер Communifire.\n{{contact}}',
	Nothing: 'Ничего',
	...
	Onboarding_title: 'Добро пожаловать в Communifire',
	Onboarding_join_open_description: 'Присоединяйтесь к нашему открытому серверу, чтобы пообщаться с командой и сообществом Communifire.',
	Onboarding_agree_terms: 'Продолжая вы соглашаетесь с правилами Communifire',
	...
	Reactions: 'Реакции',
	Read: 'Читать',
	Read_External_Permission_Message: 'Communifire необходим доступ к фотографиям, медиа и другим файлам на вашем устройстве',
	...
	Write_External_Permission_Message: 'Communifire необходим доступ к ваше Галерее, чтобы Вы могли сохранять изображения.',
	...
	You_need_to_access_at_least_one_RocketChat_server_to_share_something: 'Вам нужно получить доступ как минимум к одному серверу Communifire, чтобы поделиться чем-то.',
	...
	E2E_encryption_reset_description: 'Эта опция удалит ваш текущий E2E ключ и произведет ваш выход из системы. \nКогда вы снова войдете в систему, Communifire сгенерирует для вас новый ключ и восстановит ваш доступ ко всем зашифрованным чатам, в которых есть пользователи в сети. \nИсходя из природы E2E шифрования, Communifire не сможет восстановить доступ к чатам, в которых нет участников в сети.',
	...
	Workspace_URL_Example: 'Например, chat.your-company.communifirfe.com',
