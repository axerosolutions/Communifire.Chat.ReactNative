export default {
	...
	Invisible: '隱身',
	Invite: '邀請',
	is_a_valid_RocketChat_instance: '是一個有效的 Communifire 實例',
	is_not_a_valid_RocketChat_instance: '不是有效的 Communifire 實例',
	is_typing: '正在輸入',
	...
	Microphone_Permission_Message: 'Communifire Chat 需要存取您的麥克風，以便發送聲音訊息。',
	...
	Not_logged: '沒有記錄',
	Not_RC_Server: '這不是一個 Communifire server.\\n{{contact}}',
	Nothing: '無',
	...
	Onboarding_title: '歡迎來到 Communifire',
	Onboarding_join_open_description: '加入我們的開放工作區以與 Communifire 團隊及社群交談',
	Onboarding_agree_terms: '繼續，即表示您同意 Communifire',
	...
	Reactions: '表情貼',
	Read: '讀取',
	Read_External_Permission_Message: 'Communifire 需要存取您裝置上的相片、多媒體及檔案',
	...
	Write_External_Permission_Message: 'Communifire 需要您圖片庫的存取權限以儲存圖片。',
	...
	You_need_to_access_at_least_one_RocketChat_server_to_share_something: '您需要至少連接一個 Communifire 伺服器才能共享某些内容。',
	...
	Crash_report_disclaimer: '我們絕不記錄您的聊天內容。 崩潰報告和分析事件僅與 Communifire 有關，以便識別和修復問題。',
	Type_message: '輸入訊息',
	Room_search: '搜索聊天室',
	...
	E2E_encryption_reset_description: '此選項將撤銷您目前的*E2E 金鑰*並將您登出。\\n當您再次登入時，Communifire Chat 將產生新的一組金鑰並恢復您對任一有在線成員的加密聊天室之存取權限。\\n由於 E2E 加密的特性，Communifire Chat 無法恢復無在線成員之聊天室之存取權限。',
