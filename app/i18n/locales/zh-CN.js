export default {
	...
	Invisible: '隐身',
	Invite: '邀请',
	is_a_valid_RocketChat_instance: '是一个有效的 Communifire 实例',
	is_not_a_valid_RocketChat_instance: '不是有效的 Communifire 实例',
	is_typing: '正在输入',
	...
	Microphone_Permission_Message: 'Communifire Chat 需要存取您的麦克风，以便发送音频信息。',
	...
	Not_logged: '没有记录',
	Not_RC_Server: '这不是一个 Communifire Chat server.\\n{{contact}}',
	Nothing: '无',
	...
	Onboarding_title: '欢迎来到 Communifire',
	Onboarding_join_open_description: '加入我们的开放工作区以与 Communifire 团队及社群交谈',
	Onboarding_agree_terms: '继续，即表示您同意 Communifire',
	...
	Reactions: '表情貼',
	Read: '读取',
	Read_External_Permission_Message: 'Communifire 需要存取您装置上的相片、多媒体及文件',
	...
	Write_External_Permission_Message: 'Communifire 需要您图片库的存取权限以储存图片。',
	...
	You_need_to_access_at_least_one_RocketChat_server_to_share_something: '您需要访问至少一台Communifire Chat服务器才能共享某些内容。',
	...
	Crash_report_disclaimer: '我们从不记录您的聊天内容。 崩溃报告和分析事件仅与 Communifire 有关，以便识别和修复问题。',
	Type_message: '输入信息',
	Room_search: '搜索聊天室',
	...
	E2E_encryption_reset_description: '此选项将撤销您目前的*E2E 金钥*并将您登出。 \\n当您再次登入时，Communifire Chat 将产生新的一组金钥并恢复您对任一有在线成员的加密聊天室之存取权限。 \\n由于 E2E 加密的特性，Communifire Chat 无法恢复无在线成员之聊天室之存取权限。',
