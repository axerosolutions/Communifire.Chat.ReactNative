export default {
	...
	Invisible: '状態を隠す',
	Invite: '招待',
	is_a_valid_RocketChat_instance: 'は正しいCommunifire Chatのインスタンスです',
	is_not_a_valid_RocketChat_instance: 'はCommunifire Chatのインスタンスではありません',
	is_typing: 'が入力中',
    ...
    'Communifire Chatは音声メッセージを送信するのにマイクのアクセスの許可が必要です。',
	...
	Not_RC_Server: 'Communifire Chatサーバーではありません。\n{{contact}}',
	Nothing: '何もなし',
	...
	Offline: 'オフライン',
	Oops: 'おっと！',
	Onboarding_title: 'Communifireへようこそ',
	Online: 'オンライン',
    ...
    'Communifire Chatは画像を保存するためにギャラリーへのアクセスを求めています。',
